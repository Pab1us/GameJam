Shader "SpaceJustice/FX/Hologram/Hologram_SpaceUV_Opaque"
{
	Properties
	{
		// General
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed2 dirMult = _DirectionScanlines * i.uv;
				...
				fixed4 col = texColor * _MainColor + scan * _ScanColor * _ScanColor.a + glow * _GlowColor * _GlowColor.a * scan * _ScanColor.a + _RimColor * rim;
