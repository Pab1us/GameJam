Shader "SpaceJustice/FX/Particle/Particle Scroll2Texture Add"
{
	Properties
	{
		[Header(MainTex)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				distortion = (distortion - 0.5f) * _DistortScrollAndPower.zw;
				i.uv.xy += distortion;
				i.uv.zw += distortion;
				...
				fixed mask3 = tex2D(_MainTex, i.uv1.xy).a;

				col.a = saturate((tex1.a * tex2.a * mask3 - _CuterAlpha - (1.0f - i.color.a)) * _MultAlpha);
				return col;
			}
			ENDCG
		}
