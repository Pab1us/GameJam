Shader "SpaceJustice/FX/Hologram/Hologram Sprite SpaceLocal"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				fixed glowPre = frac(dir * _GlowTiling * 0.5f + _Time.w * _GlowSpeed) - _GlowOffset;
				fixed glow = saturate(glowPre) / (1.0f - _GlowOffset) + abs(saturate(-glowPre)) / _GlowOffset;
