...
Shader "SpaceJustice/FX/Hologram/Hologram_Sprite_SpaceScreen_Add"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
                ...
                fixed4 dirMult = _DirectionScanlines * ((IN.vertex+1)/2);
				...
				// Glow
				fixed 	glowPre = frac(dir * _GlowTiling * 0.03 + _Time.w * _GlowSpeed) - _GlowOffset;
